...
用法:
    # 回填 K线
    python -m scripts.backfill --type kline --start 2024-01-01 --end 2024-12-31
    python -m scripts.backfill --type kline --start 2024-01-01 --symbols BTC/USDT

    # 回填 tick（从指定日期开始追赶）
    python -m scripts.backfill --type tick --start 2024-06-01

    # 回填 tick（从指定 trade_id 开始）
    python -m scripts.backfill --type tick --symbol BTC/USDT --from-id 123456789

    # 回填资金费率
    python -m scripts.backfill --type funding_rate --start 2024-01-01
